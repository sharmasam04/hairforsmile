		...
		<section id="content">
			<div class="content-wrap">
				<div class="container clearfix">
					...
					<div class="">
						<h2 class="center" style="font-size: 40px;">Register as Group Hero</h2>
					</div>
						...
						<div class="row shadow bg-light border">
							...
							<div class="col-lg-4 dark" style="background: linear-gradient(rgba(0,0,0,.8), rgba(0,0,0,.2)), url('https://images.unsplash.com/photo-1511809870860-4d2806eb1908?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=668&q=80') center center / cover; min-height: 400px;">
								...
								<div class="center w-100 px-2">
									<span class="text-uppercase mb-0">Target</span>
									<h2 class=" display-3 mb-2 heading-block border-bottom-0 font-weight-semibold font-body py-2">$999,999</h2>
									<span class="text-uppercase h6">Be someone's Hero</span>
								</div>
							</div>

							<div class="col-lg-8 p-5">
								<form class="row mb-0" id="form" action="include/form.php" method="post" enctype="multipart/form-data">
									...
									<div class="col-12 form-group">
										<div class="row">
											<div class="col-sm-3 col-form-label">
												<label for="form-name">* Name:<br/><small>(Group / Organization / Lions Club)</small>:</label>
											</div>
											<div class="col-sm-9">
									...
									<div class="col-12 form-group">
										<div class="row">
											<div class="col-sm-3 col-form-label">
												<label for="form-message">Hero Message:</label>
											</div>
											<div class="col-sm-9">
												<textarea name="form-message" id="form-message" class="form-control required" cols="30" rows="5" placeholder="Tell the public why you want to be hero"></textarea>
											</div>
										</div>
									</div>
									<div class="col-12 form-group">
										<div class="row">
											<div class="col-sm-3 col-form-label">
												<label for="form-amount">Target Amount:</label>
											</div>
											<div class="col-sm-9">
												<input type="number" name="form-amount" id="form-amount" class="form-control required" value="" placeholder="550,000">
											</div>
										</div>
									</div>
									<div class="col-12 form-group">
										<div class="row">
											<div class="col-sm-3 col-form-label">
												<label for="form-photo">Photo/Image:</label>
											</div>
											<div class="col-sm-9">
												<input type="file" id="form-photo" name="form-photo" class="file-loading required" data-show-preview="false" />
												<small>Photo or logo of Group / Organization / Lions Club</small>
											</div>
										</div>
									</div>
									...
									<div class="col-12 text-center">
										<button type="submit" name="form-submit" class="btn btn-success ml-2">Submit Heroes</button>
									</div>
