		...
		<section id="content">
			<div class="content-wrap">
				<div class="container clearfix">
					...
					<div class="">
						<h2 class="center" style="font-size: 40px;">Hero Profile Maintenance</h2>
					</div>
							...
							<div class="col-lg-8 p-5">
								<form class="row mb-0" id="form" action="include/form.php" method="post" enctype="multipart/form-data">
									...
									<div class="col-12 form-group">
										<div class="row">
											<div class="col-sm-2 col-form-label">
												<label for="form-before">Photo before shave:</label>
											</div>
											<div class="col-sm-10">
												<input type="file" id="form-before" name="form-before" class="file-loading required" data-show-preview="false" />
											</div>
										</div>
									</div>
									<div class="col-12 form-group">
										<div class="row">
											<div class="col-sm-2 col-form-label">
												<label for="form-after">Photo after shave:</label>
											</div>
											<div class="col-sm-10">
												<input type="file" id="form-after" name="form-after" class="file-loading required" data-show-preview="false" />
											</div>
										</div>
									</div>
									...
									<div class="col-12 text-center">
										<button type="submit" name="form-submit" class="btn btn-success ml-2">Update Hero Profile</button>
									</div>
